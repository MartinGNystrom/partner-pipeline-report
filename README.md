...
transcripts/summaries, and Slack, a summary of certifications, awards, ATC lab/demo availability,
and other service capabilities, for any partner that isn't publicly traded an assessment of its
fundraising history, key investors, and relative financial strength, and each partner's competitive
landscape — who else plays in the same space and whether those competitors have any standing of
...
to add certifications/awards/labs/service-capability coverage; again 2026-07-21 to explicitly
answer ATC demo status and assess fundraising/investor strength for privately-held partners; and
again 2026-07-21 to add a competitive-landscape section covering competitors' own WWT standing.
...
3. Launch one subagent per company to independently verify the numbers, pull named sponsors from
   ...
   available, summarize certifications/awards/ATC lab and demo availability/service capabilities,
   assess fundraising/investors/relative financial strength for any partner that isn't publicly
   traded, identify the partner's real competitors and check each one's own WWT partner standing and
   pipeline, and write up a fuller company narrative — not just CRM numbers
